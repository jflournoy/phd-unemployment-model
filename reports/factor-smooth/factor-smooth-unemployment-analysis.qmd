...
education_colors <- c(
  "less_than_hs" = "#D73027",    # Red (highest unemployment)
  "high_school" = "#FC8D59",     # Orange
  "some_college" = "#E0C520",    # Gold/yellow-ochre
  "bachelors" = "#91CF60",       # Yellow-green
  "masters" = "#4575B4",         # Blue
  "professional" = "#762A83",    # Purple
  "phd" = "#1A1A1A"              # Near-black (lowest unemployment)
)
