...
edu_par_file <- here("models", "ode-state-space-edu-parallel-fit-v5.rds")
...
possible_model_files <- c(
  here("models", "ode-state-space-edu-parallel-fit-v5.rds"),
...
- Strong hierarchical pooling (Exponential(20) priors) on shock and adjustment parameters
