...
post-render:
  - cp state-space-comparison.html ../docs/index.html
execute:
  warning: false
  message: false
---
...
> **Note:** A B-spline boundary bug in the initial fit caused all spline deviations
> to be forced to zero at the final time point (April 2026), creating an artificial
> jump in the spline component for "less than high school." This has been fixed in
> the latest refit (`t_max` offset by 1e-6 to avoid exact boundary coincidence).
