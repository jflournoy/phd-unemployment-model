...
ggplot(predictions_by_time, aes(x = date, y = unemployment_rate * 100, color = education, fill = education)) +
  ...
  geom_point(data = raw_data, aes(y = unemployment_rate * 100), alpha = 0.3, size = 1.5) +
  ...
  labs(
    ...
    subtitle = "Raw data (points), fitted trends (lines), and 95% CIs (shaded regions)",
    x = "Year",
    y = "Unemployment Rate (%)",
