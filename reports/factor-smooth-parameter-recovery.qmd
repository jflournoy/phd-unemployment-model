...
# Boundary-safe parameters: PhD min = 0.040 - 0.005 + (-0.0001*180) - 0.006 = 0.011 (safe!)
...
```{r sim-trend}
# Boundary-safe parameters
# PhD: 0.042 - 0.010 + (-0.0001*180) - 0.006 = 0.042 - 0.010 - 0.018 - 0.006 = 0.008 (safe!)
# Masters: 0.075 - 0.010 + (-0.0003*180) - 0.006 = 0.075 - 0.010 - 0.054 - 0.006 = 0.005 (safe!)
# Bachelors: 0.115 - 0.010 + (-0.0005*180) - 0.006 = 0.115 - 0.010 - 0.090 - 0.006 = 0.009 (safe!)
...
# Boundary-safe: no trend, Bachelor's min = 0.065 - 0.025 - 0.006 = 0.034 (safe!)
...
# Boundary-safe: same as main trend test
...
# Boundary-safe: Bachelor's min = 0.125 - 0.025 + (-0.0005*180) - 0.006 = 0.004 (safe!)
...
run_model_selection_sim <- function(scenario, sim_id) {
  if (scenario == "seasonal_only") {
    # Boundary-safe: no trend, so baseline - amplitude - 3*noise = 0.040 - 0.025 - 0.006 = 0.009 (safe!)
    ...
    # Boundary-safe: Bachelor's min = 0.105 - 0.010 + (-0.0005*180) - 0.006 = 0.099 - 0.096 = 0.003 → need higher!
    sim_data <- simulate_multi_education_unemployment(
      n_years = 15,
      education_levels = c("phd", "masters", "bachelors"),
    ...
    # Boundary-safe: Bachelor's min = 0.115 - 0.025 + (-0.0005*180) - 0.006 = 0.090 - 0.096 = -0.006 → need 0.125!
    sim_data <- simulate_multi_education_unemployment(
      n_years = 15,
      education_levels = c("phd", "masters", "bachelors"),
      baseline_rates = c(phd = 0.042, masters = 0.075, bachelors = 0.125),
